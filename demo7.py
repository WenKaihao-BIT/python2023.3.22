...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.textBrowser_motor3 = QtWidgets.QTextBrowser(self.frame_2)
        self.textBrowser_motor3.setFrameShape(QtWidgets.QFrame.Box)
        self.textBrowser_motor3.setObjectName("textBrowser_motor3")
        self.gridLayout_7.addWidget(self.textBrowser_motor3, 4, 1, 2, 1)
        self.textBrowser_F = QtWidgets.QTextBrowser(self.frame_2)
        self.textBrowser_F.setFrameShape(QtWidgets.QFrame.Box)
        self.textBrowser_F.setObjectName("textBrowser_F")
        self.gridLayout_7.addWidget(self.textBrowser_F, 0, 2, 6, 1)
        self.textBrowser_imagey = QtWidgets.QTextBrowser(self.frame_2)
        self.textBrowser_imagey.setFrameShape(QtWidgets.QFrame.Box)
        self.textBrowser_imagey.setObjectName("textBrowser_imagey")
        self.gridLayout_7.addWidget(self.textBrowser_imagey, 3, 0, 3, 1)
        self.textBrowser_motor2 = QtWidgets.QTextBrowser(self.frame_2)
        self.textBrowser_motor2.setFrameShape(QtWidgets.QFrame.Box)
        self.textBrowser_motor2.setObjectName("textBrowser_motor2")
        self.gridLayout_7.addWidget(self.textBrowser_motor2, 2, 1, 2, 1)
        self.textBrowser_imagex = QtWidgets.QTextBrowser(self.frame_2)
        self.textBrowser_imagex.setFrameShape(QtWidgets.QFrame.Box)
        self.textBrowser_imagex.setObjectName("textBrowser_imagex")
        self.gridLayout_7.addWidget(self.textBrowser_imagex, 0, 0, 3, 1)
        self.textBrowser_motor1 = QtWidgets.QTextBrowser(self.frame_2)
        self.textBrowser_motor1.setFrameShape(QtWidgets.QFrame.Box)
        self.textBrowser_motor1.setObjectName("textBrowser_motor1")
        self.gridLayout_7.addWidget(self.textBrowser_motor1, 0, 1, 2, 1)
