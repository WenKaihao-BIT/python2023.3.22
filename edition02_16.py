...
class Ui_MainWindow(QtWidgets.QWidget):
    ...
    # 电机增量运动
    def motor1_PR(self):
        self.ser_motor1.send = '1PR' + str(self.step_motor1) + '\r'
        self.ser_motor1.senddata()
    ...
    def motor2_PR(self):
        temp = 'MOVEINC ' + str(self.step_motor2) + ' 4'
        self.ser_motor2.send = temp + '<' + self.checksum(temp) + '>\r'
        self.ser_motor2.senddata()
