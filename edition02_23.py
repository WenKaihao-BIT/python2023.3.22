...
class Ui_MainWindow(QtWidgets.QWidget):
    ...
    def button_connect(self):
        ...
        # self.lineEdit_A.editingFinished.connect(self.sin_A)
        # self.lineEdit_F.editingFinished.connect(self.sin_F)
        # self.lineEdit_D.editingFinished.connect(self.sin_D)
        # self.lineEdit_B.editingFinished.connect(self.sin_B)
